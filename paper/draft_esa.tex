...
\bottomrule
\end{tabular}
\caption{Comparison of \textsc{BlindGreedy} and \textsc{Greedy} algorithms for 0-dimensional
...
in dimensions 2, 3 and 4 in the plot \ref{fig:blind_greedy_dimensions}.
