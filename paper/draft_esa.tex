...
\begin{tikzpicture}
    ...
    %\addplot+ table [x=n_points, y=ratio_greedy_dim_0_eps_01_q_1, col sep=comma] {mcgill_perturbed_blind_greedy.csv};
    %\addlegendentry{Greedy, $\eps = 0.1$}

    %\addplot+ table [x=n_points, y=ratio_blind_greedy_dim_0_eps_01_q_1, col sep=comma] {mcgill_perturbed_blind_greedy.csv};
    %\addlegendentry{Blind greedy, $\eps = 0.1$}

    \addplot+ table [x=n_points, y=ratio_greedy_dim_0_eps_02_q_1, col sep=comma] {mcgill_perturbed_blind_greedy.csv};
    \addlegendentry{Greedy, $\eps = 0.2$}

    \addplot+ table [x=n_points, y=ratio_blind_greedy_dim_0_eps_02_q_1, col sep=comma] {mcgill_perturbed_blind_greedy.csv};
    \addlegendentry{Blind greedy, $\eps = 0.2$}

    \addplot+ table [x=n_points, y=ratio_greedy_dim_0_eps_05_q_1, col sep=comma] {mcgill_perturbed_blind_greedy.csv};
    \addlegendentry{Greedy, $\eps = 0.5$}

    \addplot+ table [x=n_points, y=ratio_blind_greedy_dim_0_eps_05_q_1, col sep=comma] {mcgill_perturbed_blind_greedy.csv};
...
\end{centering}
    %\includegraphics[width=0.7\textwidth]{pics/edges_to_points_ratio_dim_2_normal_points.png}
    \caption{Ratio \# edges / \# diagrams for blind greedy spanner 
    algorithm. The plot is for 0-dimensional diagrams of perturbed McGill data
...
\begin{tikzpicture}
    ...
    \addplot+ table [x=n_points, y=sparseness_greedy_dim_0_eps_01_q_1, col sep=comma] {mcgill_perturbed_blind_greedy.csv};
    \addlegendentry{Greedy, $\eps = 0.1$}

    \addplot+ table [x=n_points, y=sparseness_blind_greedy_dim_0_eps_01_q_1, col sep=comma] {mcgill_perturbed_blind_greedy.csv};
    \addlegendentry{Blind greedy, $\eps = 0.1$}

    \addplot+ table [x=n_points, y=sparseness_greedy_dim_0_eps_02_q_1, col sep=comma] {mcgill_perturbed_blind_greedy.csv};
    \addlegendentry{Greedy, $\eps = 0.2$}

    \addplot+ table [x=n_points, y=sparseness_blind_greedy_dim_0_eps_02_q_1, col sep=comma] {mcgill_perturbed_blind_greedy.csv};
    \addlegendentry{Blind greedy, $\eps = 0.2$}

    \addplot+ table [x=n_points, y=sparseness_greedy_dim_0_eps_05_q_1, col sep=comma] {mcgill_perturbed_blind_greedy.csv};
    \addlegendentry{Greedy, $\eps = 0.5$}

    \addplot+ table [x=n_points, y=sparseness_blind_greedy_dim_0_eps_05_q_1, col sep=comma] {mcgill_perturbed_blind_greedy.csv};
    \addlegendentry{Blind greedy, $\eps = 0.5$}
...
\end{centering}
    %\includegraphics[width=0.7\textwidth]{pics/edges_to_points_ratio_dim_2_normal_points.png}
    \caption{Ratio \# edges / \# all distances for blind greedy spanner 
    algorithm. The plot is for 0-dimensional diagrams of perturbed McGill data
    $\eps = 0.1, 0.2, 0.5$ with $W_1$ distance.}
    \label{fig:spanner_ratio}
\end{figure}
