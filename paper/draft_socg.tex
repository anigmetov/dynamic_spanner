...
Our experiments with Earth Mover distance and persistence
diagrams of 3-D shapes show that blind greedy spanner can speed up computations
by a factor of 3, saving hundreds of hours of machine time,
even though the images and diagrams in our data sets are of moderate size.
...
dataset and the code for computing the Earth Mover distance
by Gary Dornan.
