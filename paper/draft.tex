...
A subgraph $G$ of this graph is called a \emph{$(1+\eps)$-spanner} for $(X,\dist)$ 
...
\begin{figure}[ht]
    ...
    Next $p_i$ is placed in the curvilinear triange formed by the balls around the query point, $p_2$ and $p_{i-1}$.}
