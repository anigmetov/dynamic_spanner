...
outperforms naive computation of all pairwise distances or runs slighly slower, depending on the approximation
quality.
...
Let us emphasize that the diagrams we have are rather small, with average cardinality
