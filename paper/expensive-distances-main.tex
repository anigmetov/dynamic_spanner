...
\centering
\subcaptionbox{Ratio \# edges / \# points for different variants of spanner 
            algorithms. The plot is for normally distributed points
            in dimension 2, $\eps = 0.1$.}[.5\textwidth]{%
\begin{tikzpicture}
...
\end{tikzpicture}}%
\subcaptionbox{Number of edges in the blind greedy and greedy spanners for different values of $\eps$. Data is for 400 normally distributed points in $\RR^2$ and $\RR^3$.}[.5\textwidth]{
    \begin{tikzpicture}
