...
runs faster than naive computation of all pairwise distances or runs slightly slower, depending on the approximation
quality.
...
with Wasserstein distance\footnote{definition of $\wsdist{q}$ can be found in \cref{sec:appendix_background}}.
