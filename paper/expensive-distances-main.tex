...
at dimension 0, since the diagrams in this dimension are larger in size.
...
If one compares the running time with the sparseness results,
it becomes evident that in this case the overhead of \bgrdy algorithm
is rather small, compared to the time needed to compute the distances.
Let us emphasize that the diagrams we have are still rather small, with a typical cardinality
between 100 and 300 points. Nevertheless, even on this data set \bgrdy spanner
